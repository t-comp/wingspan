...
const ButterflyAPI = {
  ...
  async getSpeciesById(speciesId: any) {
  ...
  async filterSpecies(orderName: string, family: string, genus: string) {
  ...
  async setThumbnail(speciesId: any, imageId: any) {
    const response = await fetch(
  ...
  async removeThumbnail(speciesId: any) {
    const response = await fetch(
  ...
  // USER / AUTH ENDPOINTS
  // ==========================
  async login(usernameVal: any, passwordVal: any) {
  ...
  async getStudentDashboard(email: any) {
    const response = await fetch(
  ...
  async updateUsername(userId: any, newUsername: any) {
    const response = await fetch(
  ...
  async deactivateApiKey(keyId: any) {
    const response = await fetch(
  ...
  async activateApiKey(keyId: any) {
  ...
  async extendApiKey(keyId: any, months: any) {
    const response = await fetch(
  ...
  // TEAM ENDPOINTS
  // ==========================
  async createTeam(data: { name: any; projectName: any; semester: any }) {
  ...
  async getTeamMembers(teamId: any) {
  ...
  async addTeamMember(teamId: any, userId: string) {
  ...
  async removeTeamMember(teamId: any, userId: string) {
    const response = await fetch(
  ...
  async updateTeam(teamId: any, data: any) {
  ...
  async getImagesBySpecies(speciesId: any) {
    const response = await fetch(
  ...
  async addTagToImage(tagId: string, imageId: any) {
    const response = await fetch(
  ...
  async removeTagFromImage(tagId: any, imageId: any) {
    const response = await fetch(
      `${API_BASE_URL}/tags/${tagId}/images/${imageId}`,
      {
        method: "DELETE",
  ...
  async updateTag(tagId: any, tagData: any) {
    const response = await fetch(`${API_BASE_URL}/tags/admin/${tagId}`, {
      method: "PUT",
      headers: getHeaders(),
      body: JSON.stringify(tagData),
  ...
  async filterImagesByTags(tagIds: any[]) {
    const queryString = tagIds.map((id: string) => "tagIds=" + id).join("&");
    const response = await fetch(
