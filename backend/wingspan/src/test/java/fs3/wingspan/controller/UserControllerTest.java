...
class UserControllerTest extends AbstractIntegrationTest {
    ...
    void createAccount_duplicateUsername_returns409() throws Exception {
        // savedAdmin already has username "testadmin"
        String body = """
                {"username":"testadmin","email":"another@test.com","password":"password1"}
                """;
        mockMvc.perform(post("/user/create-account")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(body))
    ...
    void createAccount_duplicateEmail_returns409() throws Exception {
        // savedAdmin already has email "admin@test.com"
        String body = """
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // PUT /{userId}/make-admin  – ADMIN required
    // ══════════════════════════════════════════════════════════════════════════
